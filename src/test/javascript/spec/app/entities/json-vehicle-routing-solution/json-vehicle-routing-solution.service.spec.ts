...
describe('Service Tests', () => {
    ...
    describe('JsonVehicleRoutingSolution Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(JsonVehicleRoutingSolutionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/json-vehicle-routing-solutions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return JsonVehicleRoutingSolution', () => {
