...
/**
 * Performance test for the JsonVehicleRoutingSolution entity.
 */
class JsonVehicleRoutingSolutionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the JsonVehicleRoutingSolution entity")
